 ...
 *
 * Holds configuration parameters for both the SSD1306 display and the I2C
 * master.
 */
typedef struct {
 ...
 *
 * Contains runtime information including the I2C device handle, display
 * dimensions, and pointers to the page buffers.
 */
typedef struct {
 ...
 *
 * Configures and initializes the SSD1306 display using the provided I2C bus and
 * configuration.
 *
 ...
 *
 * Prints the hexadecimal values of each segment in every page of the SSD1306
 ...
 *
 * Copies 8x8 font characters representing the provided string into the SSD1306
 * buffer.
 *
 * @param i2c_ssd1306 Pointer to the SSD1306 handle.
 ...
 *
 * Copies 8x8 font characters representing the given integer into the SSD1306
 * buffer.
 *
 * @param i2c_ssd1306 Pointer to the SSD1306 handle.
 ...
 *
 * Copies 8x8 font characters representing the given float value into the
 * SSD1306 buffer.
 *
 * @param i2c_ssd1306 Pointer to the SSD1306 handle.
 ...
 *
 * Copies the provided image data into the SSD1306 buffer at an 8x8 pixel
 * resolution.
 *
 * @param i2c_ssd1306 Pointer to the SSD1306 handle.
 ...
 *
 * Moves the designated segment from the buffer to the corresponding location in
 * the display's RAM.
 *
 * @param i2c_ssd1306 Pointer to the SSD1306 handle.
 ...
 *
 * Moves a sequence of segments from the specified page in the buffer to the
 * display's RAM.
 *
 * @param i2c_ssd1306     Pointer to the SSD1306 handle.
 ...
 *
 * Updates the display's RAM by transferring all segments for pages within the
 * specified range.
 *
 * @param i2c_ssd1306 Pointer to the SSD1306 handle.
 ...
 *
 * Updates the display's RAM by transferring the contents of all pages in the
 * buffer.
 *
 * @param i2c_ssd1306 Pointer to the SSD1306 handle.
 *
